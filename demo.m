...
%% Running
PHM_score = PHM(pt_r, pt_d, pt_fast, param); % Parallel computing with higher memory cost and faster speed 
% PHM_score = PHM_old(pt_r, pt_d, pt_fast, param);  % Non-Parallel computing with lower memory cost and slower speed 
